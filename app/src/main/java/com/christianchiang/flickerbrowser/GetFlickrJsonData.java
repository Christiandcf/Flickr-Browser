...
/**
 * Created by Christian on 8/2/2016.
 */
public class GetFlickrJsonData extends GetRawData {
    ...
    public boolean createAndUpdateUri(String searchCriteria, boolean matchAll) {
        ...
        mDestinationUri = Uri.parse(FLICKR_API_BASE_URL).buildUpon() //parsing through what you tell them too
                .appendQueryParameter(TAGS_PARAM, searchCriteria)
                .appendQueryParameter(TAGMODE_PARAM, matchAll ? "ALL" : "ANY")  //if true is ALL else is ANY
    ...
    public void processResult(){
        ...
        try{
            ...
            for (int i =0; i<itemsArray.length(); i++){
                ...
                Photo photoObject = new Photo(title, author, authorId, link, tags, photoURL); //Java default
